...
> route autonome vers la weak recovery. Son rôle dans la piste actuelle est
> précisé par le
...
Le [calcul des frontières critiques](../foundations/ancestral/14_CRITICAL_COMPONENT_BOUNDARY.md)
