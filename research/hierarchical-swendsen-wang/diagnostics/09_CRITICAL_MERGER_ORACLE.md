...
> [fichier 10](../foundations/ancestral/10_ANCESTRAL_LAMBDA_ESTIMATION.md). Aucun résultat local de ce
...
[fichier 12](../archive/roadmaps/12_FAVORABLE_HIERARCHICAL_REDUCTION.md) absorbe alors en une seule
...
[calcul des frontières critiques](../foundations/ancestral/14_CRITICAL_COMPONENT_BOUNDARY.md)
