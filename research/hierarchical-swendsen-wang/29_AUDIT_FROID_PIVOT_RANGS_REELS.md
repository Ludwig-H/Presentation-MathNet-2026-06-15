...
> aussi une impasse probable. La voie prioritaire est désormais la
> [dissipation $`L^2`$ globale](30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md)
> sous des projections collapsed aux rangs réels. Aucun résultat de cette
> note ne donne encore une nouvelle borne de weak recovery.
...
[fichier 19](19_FAVORABLE_SWEEP_PROJECTIONS.md) reste donc valide.
...
Le théorème 4.1 du [fichier 20](20_COLLAPSED_CORRIDOR_BLACKWELL.md) reste un
...
| $`L`$ | environnements | candidats | $`|B|\le1`$ | $`|B|\le2`$ | $`|B|\le4`$ | médiane de $`|B|`$ fini |
|---:|---:|---:|---:|---:|---:|---:|
...
| $`L`$ | environnements | charge au rang réel | puis $`|B|\le1`$ | puis $`|B|\le2`$ | puis $`|B|\le4`$ |
|---:|---:|---:|---:|---:|---:|
...
[fichier 30](30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md).
...
[feuille de pivot](30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md) donne le
