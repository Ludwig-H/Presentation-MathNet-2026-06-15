...
> [pivot quadratique aux rangs réels](../../active/30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md),
> restreint aux [cellules critiques
> pondérées](../../active/33_SOUS_FEUILLE_ROUTE_CELLULES_CRITIQUES_L2.md). La voie de ce
...
31](../../archive/certificates/31_CERTIFICAT_RATIONNEL_A0.md). Ainsi,
...
03](../../foundations/03_HIERARCHICAL_WEAK_RECOVERY.md) est
...
pondérées par l'énergie](../../active/33_SOUS_FEUILLE_ROUTE_CELLULES_CRITIQUES_L2.md), en
