...
> [!IMPORTANT]
> Le [fichier 30](../active/30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md) remplace la
...
[fichier 29](../diagnostics/29_AUDIT_FROID_PIVOT_RANGS_REELS.md) donne un contre-exemple
...
sont recensées dans [l'état de l'art](../references/LITERATURE.md).
