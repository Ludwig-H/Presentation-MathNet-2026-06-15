...
Les identités, les quatre événements face à la vérité et la formule exacte contenant $`\beta_u=\xi_{e_u}`$ sont développés dans [06_LCA_SPIN_CORRELATION.md](../archive/oracles/06_LCA_SPIN_CORRELATION.md).
...
Le [calcul par chemin descendant](../archive/oracles/16_FLIP_PROBABILITIES_DESCENDANT_PATH.md)
...
Le [seuil de décorrélation du chemin](../archive/oracles/17_PATH_DECORRELATION_THRESHOLD.md)
