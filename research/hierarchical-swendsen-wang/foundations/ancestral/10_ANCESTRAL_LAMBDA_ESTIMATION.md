...
6. **Établi comme implication conditionnelle historique.** Le
   [théorème de réduction favorable](../../archive/roadmaps/12_FAVORABLE_HIERARCHICAL_REDUCTION.md)
   montre que l'annulation de la fiabilité critique implique l'impossibilité
   globale sous HF. Le [fichier 29](../../diagnostics/29_AUDIT_FROID_PIVOT_RANGS_REELS.md)
...
Le lemme 6.1 du [fichier 12](../../archive/roadmaps/12_FAVORABLE_HIERARCHICAL_REDUCTION.md) transporte
