...
Les démonstrations générales et la distinction entre couplage depuis la vérité et réplique indépendante sont dans [06_LCA_SPIN_CORRELATION.md](../archive/oracles/06_LCA_SPIN_CORRELATION.md).
...
Le [calcul multi-état complet](../results/non_hierarchical/11_TRIANGLE_BLOCK_SDPI.md) conserve séparément
...
34](../results/non_hierarchical/34_CERTIFICAT_RATIONNEL_P809439.md), information-percolation et le régime
...
[corridor collapsed aux rangs réels](../diagnostics/29_AUDIT_FROID_PIVOT_RANGS_REELS.md),
resserré aux [cellules critiques
pondérées](../active/33_SOUS_FEUILLE_ROUTE_CELLULES_CRITIQUES_L2.md). La tensorisation
de Blackwell à squelette fixé est réfutée en dehors du surrogate mono-bit. La
[calibration entropique par horloges](../diagnostics/13_NISHIMORI_HIERARCHICAL_CLOCKS.md)
retrouve exactement l'équation de Nishimori--Ohzeki au niveau d'une face. Le
[calcul des frontières critiques](ancestral/14_CRITICAL_COMPONENT_BOUNDARY.md)
...
[certificat cactus](../results/hierarchical/21_CACTUS_COLLAPSED_CERTIFICATE.md) calcule désormais le
