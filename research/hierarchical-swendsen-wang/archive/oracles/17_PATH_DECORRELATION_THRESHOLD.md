...
> [!WARNING]
> **Oracle archivé.** Ce seuil concerne le modèle factorisé PATH-FAC et n'est
> pas transféré à la grille triangulaire. Voir le
> [programme actuel](../../CURRENT_STATUS.md).
...
[l'état de l'art](../../references/LITERATURE.md#bande-critique-pivots-et-sprinkling).
...
[transfert répliqué sous Palm critique](../../foundations/18_CRITICAL_PALM_REPLICATED_TRANSFER.md)
