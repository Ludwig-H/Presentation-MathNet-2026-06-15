...
> [!WARNING]
> **Document archivé.** Le mot « optimale » appartient au titre historique :
> la route annulaire uniforme n'est plus la stratégie retenue. Voir le
> [statut actuel](../../CURRENT_STATUS.md).

> [!NOTE]
> La version synthétique et l'ordre de travail courant sont dans le
> [programme prioritaire](00_RESEARCH_PROGRAM.md). Le
> [contre-audit multiport](../../diagnostics/29_AUDIT_FROID_PIVOT_RANGS_REELS.md) invalide
> l'étape historique de criticalisation ci-dessous. L'architecture annulaire
> reste pertinente, mais le [pivot quadratique](../../active/30_PIVOT_DISSIPATION_L2_SECTEUR_IMPAIR.md)
