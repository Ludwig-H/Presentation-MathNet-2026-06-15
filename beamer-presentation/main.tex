...
{\small Inria Sophia Antipolis, doctorant superv. by \href{https://www-sop.inria.fr/members/Konstantin.Avratchenkov/}{Konstantin \textsc{Avrachenkov}} \& \href{https://www-sop.inria.fr/members/Josiane.Zerubia/index-eng.html}{Josiane \textsc{Zerubia}}}}
...
\begin{frame}{Motivation: Haplotype Assembly}
  \begin{block}{Reconstructing Chromosomes from DNA Reads}
    \begin{itemize}
      ...
      \item \textbf{Goal:} Reconstruct the true chromosome assignments {\Large $\boldsymbol{\Sigma}$} (Haplotype 1 vs 2) for all reads.
    \end{itemize}
  \end{block}
