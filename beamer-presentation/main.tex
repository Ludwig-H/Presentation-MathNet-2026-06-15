      ...
      \begin{center}
        \begin{tikzpicture}[scale=1.1, x=1cm, y=1cm]
          ...
          \begin{scope}[shift={(2.8,0.2)}]
            ...
            % Nodes
            \node[spin, fill=inria-2024-rouge!15!white, draw=inria-2024-rouge!80!black] at (T) {$\mathbf{T}$};
            \node[spin, fill=gray!10] at (Xi2) {$x_i$};
            \node[spin, fill=gray!10] at (Xj2) {$\neg x_j$};
            \node[spin, fill=gray!10] at (Xk2) {$x_k$};

            \node[above=3pt, text=inria-2024-rouge!80!black, scale=0.9] at (T) {\textbf{\textsf{True}}};
