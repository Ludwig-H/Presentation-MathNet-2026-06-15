...
\begin{frame}{General Swendsen--Wang Cluster Dynamics}
...
\begin{frame}{General Swendsen--Wang Cluster Dynamics}
  ...
  \begin{theorem}[Gibbs Invariance \textcolor{inria-2024-rouge!80!black}{\cite{BibiInformationInference}}]
...
\begin{frame}{Coupling \& the \textsc{Sankararaman}--\textsc{Baccelli} Bound}
  \begin{block}{One Step of Classical Edge-by-Edge Swendsen--Wang}
...
\begin{frame}{Towards a Practical Community Detection Algorithm}
  \begin{block}{Limits of Direct Gibbs Sampling}
    \begin{itemize}
      \item Empirically, recovering communities by sampling directly from the Gibbs distribution does not perform well.
