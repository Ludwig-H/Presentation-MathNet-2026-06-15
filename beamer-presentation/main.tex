...
\begin{frame}{High-Order Triangular Dynamics}
  ...
  \begin{block}{Triangular Cluster Dynamics \textcolor{inria-2024-rouge!80!black}{\cite{BibiMonterey}}}
    \begin{itemize}
      ...
      \item \textbf{Repulsive Triangle} (2 satisfied, 1 unsatisfied): Freeze \textbf{exactly one} of the two satisfied edges (prob $a_u/2$). Minimal freezing keeps the dynamics active.
    \end{itemize}
  \end{block}
\end{frame}
