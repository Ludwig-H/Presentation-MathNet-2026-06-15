...
\begin{frame}{High-Order Triangular Dynamics}
  \begin{block}{The Frustration Obstruction}
    \begin{itemize}
      \item \textbf{Frustration}: Cycles with an odd number of negative interactions (conflicting constraints).
      \item \textbf{Excessive Freezing}: In frustrated graphs, standard SW satisfies and freezes too many edges independently, blocking/freezing the MCMC dynamics.
      \item \textbf{Higher-Order Idea}: Group interactions into \textbf{triangles} to correlate the freezing mechanism and \textbf{freeze as little as possible}.
    \end{itemize}
  \end{block}
