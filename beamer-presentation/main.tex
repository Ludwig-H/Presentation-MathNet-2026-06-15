...
{\small Inria Sophia Antipolis, doctorant superv. by \href{https://www-sop.inria.fr/members/Konstantin.Avratchenkov/}{Konstantin \textsc{Avrachenkov}} \& \href{https://www-sop.inria.fr/members/Josiane.Zerubia/index-eng.html}{Josiane \textsc{Zerubia}}\\[6pt]
Joint work with \href{https://www-sop.inria.fr/members/Konstantin.Avratchenkov/}{Konstantin \textsc{Avrachenkov}} (Inria Sophia Antipolis)\\
and \href{https://nahuelsopranoloto.github.io/}{Nahuel \textsc{Soprano-Loto}} (Inria Paris)}}
...
\begin{frame}{Motivation: Signed Community Detection}
  \begin{block}{Community Detection on Signed Graphs ($K=2$)}
    \begin{itemize}
      ...
      \item Observed links are signed, representing \textbf{attractions} ($+$) and \textbf{repulsions} ($-$).
