...
\begin{frame}{The \textsc{Sankararaman}--\textsc{Baccelli} Model (GSBM)}
  \begin{block}{Model Definition \cite{SankararamanBaccelli2018}}
    \begin{itemize}
      \item \textbf{Spatial Nodes $V_n$}: Hom. \textsc{Poisson} PP $\mathcal{X}$ in $\mathbb{R}^d$ \cite{BB} restrict. to a $n$-volume window. Let $X_i$ be the position of node $i \in V_n$.
